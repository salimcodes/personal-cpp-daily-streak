...
int main()
{
    ...
    cout.setf(ios:: fixed);
    cout.precision(2);
    cout << endl << "THE UNITS ATTEMPTED BY " << name << " is " << UA << endl;
    cout << endl <<"THE UNITS PASSED BY " << name << " is " << UP << endl;
    cout << endl <<"THE WEIGHTED SCORE FOR " << name << " is " << WS << endl;
    cout << endl <<"THE SEMESTER GRADE POINT AVERAGE FOR "<< name << " is " << WS/UA << endl;
